...
public class CircuitMathTest {
    ...
    public void testSimpleSeriesCircuit() {
        ...
        edu.vanier.strawberries.Models.Battery battery = new edu.vanier.strawberries.Models.Battery(n1, n2, 12, true);  // 12V

        edu.vanier.strawberries.Models.Resistor resistor = new edu.vanier.strawberries.Models.Resistor(n3, n4, 6, true);   // 6Ω

        edu.vanier.strawberries.Models.Circuit circuit = new edu.vanier.strawberries.Models.Circuit(false);
